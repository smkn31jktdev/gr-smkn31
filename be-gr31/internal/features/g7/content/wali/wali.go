...
// CheckIsGuruWali checks if an admin has Guru Wali (Homeroom) role and returns their assigned students
...
// VerifyAdminAccessToStudent verifies if the requesting admin is authorized to view this student's data
