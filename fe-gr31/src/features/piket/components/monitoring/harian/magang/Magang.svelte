...
<td class="p-4 pl-6">
  <button 
    ...
    title="Klik untuk melihat detail lampiran/alasan"
  >
...
<!-- Waktu -->
<td class="p-4">
  <span class="font-semibold font-mono text-slate-550">
...
<td class="p-4 text-slate-550 font-medium max-w-[200px] truncate">
  {#if log.fotoIzin}
    <button 
      onclick={() => onOpenPermit(log)} 
      class="inline-flex items-center gap-1 text-[#00a294] hover:text-[#008f83] font-bold hover:underline border-none bg-transparent cursor-pointer p-0"
    >
      Lihat Lampiran
